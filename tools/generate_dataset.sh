...
OUT_ROOT="${OUT_ROOT:-../inference_out}"
DATASET="${DATASET:-../datasets/ours}"
FIRST_REVIEWED_FRAME="${FIRST_REVIEWED_FRAME:-1940}"

# 1. Keep the reviewed frames, collapse roles onto ball/player, split train/test.
for CAM in left right; do
    python3 detection/prepare_labels.py \
...
python3 detection/build_dataset.py \
